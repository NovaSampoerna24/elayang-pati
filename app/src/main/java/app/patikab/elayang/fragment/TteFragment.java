...
import app.patikab.elayang.DetailMailTteActivity;
 ...
 */
public class TteFragment extends Fragment implements ListKonsepAdapter.IKonsepAdapter, RequestHandler.IParse {
    ...
    private void reqDataMail(String keyword) {
        ...
        try {
            ...
            handler.request(Request.Method.GET, Endpoint.TTE_SURAT_KELUAR, new JSONObject(jsonReq));
    ...
    public void onClick(String id, String data, View view) {
        startActivity(new Intent(getActivity(), DetailMailTteActivity.class)
    ...
    public void parseResponses(Boolean isSuccess, String method, String data) {
        ...
        if (isSuccess) {
            if (method.equals(Endpoint.TTE_SURAT_KELUAR)) {
                try {
