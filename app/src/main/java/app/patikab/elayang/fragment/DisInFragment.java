...
import app.patikab.elayang.adapter.ListInDispositionAdapter;
 ...
 */
public class DisInFragment extends Fragment
        implements ListInDispositionAdapter.IDispositionAdapter, RequestHandler.IParse {
    ...
    ListInDispositionAdapter dispositionAdapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View v = inflater.inflate(R.layout.fragment_dis_in, container, false);
        ButterKnife.bind(this, v);

        dispositionAdapter = new ListInDispositionAdapter(getActivity(), this, dispositions);
    ...
    private void reqDataDispo(String keyword) {
        ...
        try {
            ...
            handler.request(Request.Method.GET, Endpoint.DISPOSISI_LIST_IN, new JSONObject(jsonReq));
    ...
    public void parseResponses(Boolean isSuccess, String method, String data) {
        ...
        if (isSuccess) {
            if (method.equals(Endpoint.DISPOSISI_LIST_IN)) {
                try {
