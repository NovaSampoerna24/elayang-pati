...
public class ListOutDispositionAdapter extends RecyclerView.Adapter<ListOutDispositionAdapter.ViewHolder> {
    ...
    public ListOutDispositionAdapter(Context context, IDispositionAdapter mIDispositionAdapter, List<Disposition> dispositions) {
    ...
    @NonNull
    @Override
    public ListOutDispositionAdapter.ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NonNull final ListOutDispositionAdapter.ViewHolder holder, int position) {
        final Disposition disposition = dispositions.get(position);
...
//        }
        ...
        holder.tvPengirim.setText((disposition.getNama_penerima()));
        holder.tvInstansi.setText(disposition.getJabatan_penerima());
