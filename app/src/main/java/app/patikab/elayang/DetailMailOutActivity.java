...
public class DetailMailOutActivity extends AppCompatActivity
        implements RequestHandler.IParse, ListPemeriksaAdapter.IPemeriksaAdapter, ListPengirimanAdapter.IPengirimanAdapter {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_detail_mail_out);
...
//            startActivity(intent);
    ...
    private void reqDetailMail() {
        ...
        handler.request(Request.Method.GET, Endpoint.SURAT_KELUAR_DETAIL + idMail, null);
    }
    ...
    public void parseResponses(Boolean isSuccess, String method, String data) {
        if (isSuccess) {
            if (method.equals(Endpoint.SURAT_KELUAR_DETAIL + idMail)) {
                try {
